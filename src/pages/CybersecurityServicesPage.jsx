      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-300">
            Centcom Systems provides cybersecurity and compliance services for
            businesses, schools and multi-site organisations across Slough,
            London and the UK. We help organisations reduce risk, strengthen
            security and meet modern compliance requirements.
          </p>
  
          <p className="mt-4 leading-7 text-slate-400">
            Our approach focuses on practical, real-world protection across
            endpoints, networks, cloud systems and user behaviour, ensuring your
        ...
        <div className="mt-20">
          ...
          <p className="mt-6 max-w-4xl leading-8 text-slate-300">
            Cyber threats are constantly evolving, and organisations of all sizes
            are targets. A strong security posture is no longer optional — it is
            essential. Our services are designed to reduce vulnerabilities,
        ...
        <div className="mt-20 rounded-[2rem] border border-cyan-400/20 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 p-10 text-center">
          ...
          <p className="mt-4 text-slate-300">
            Speak to our team about cybersecurity, compliance and risk reduction
